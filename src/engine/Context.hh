...
namespace Eqo {
extern Eqo::EqObjPtr DLL_PROTECTED default_derivative_rule(Eqo::EqObjPtr,
                                                           Eqo::EqObjPtr);
}
...
class ContextData {
 public:
  ContextData()
      : callback_func_ptr_(nullptr),
        model_derivative_rule_ptr_(Eqo::default_derivative_rule)
  {
  }
