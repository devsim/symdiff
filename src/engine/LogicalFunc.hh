...
class UnaryLogical : public EquationObject {
 public:
  ...
  const std::string &getOperator() const { return unaryOperator; }

  std::string getName() const { return getOperator(); }
...
class BinaryLogical : public EquationObject {
 public:
  ...
  const std::string &getOperator() const { return binaryOperator; }
